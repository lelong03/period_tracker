...
class Home4Bottomsheet extends StatelessWidget {
  Home4Bottomsheet({Key? key})
      : super(
          key: key,
        );

  TextEditingController frame427320234Controller = TextEditingController();
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              controller: frame427320234Controller,
              margin: getMargin(
                top: 8,
              ),
              ...
              hintText: "Ngày kinh thứ 2 - Tỷ lệ mang thai thấp",
